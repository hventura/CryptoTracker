...
fun LineChart(
    ...
    Canvas(
        ...
        // UNCOMMENT IF NEED TO SEE THE GREEN VIEWPORT
        /*
        val viewPort = Rect(
            left = viewPortLeftX,
            top = viewPortTopY,
        ...
        */
        ...
        xLabelTextLayoutResults.forEachIndexed { index, result ->
            ...
            // TEXT OF SELECTED DATA POINT IN TOP
